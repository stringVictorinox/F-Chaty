...
export default function LandingPage(){
  return (
    <div className="LandingPage h-screen">
        ...
        <div className="Landing-top flex relative overflow-hidden flex-col h-3/4 bg-gradient-to-r from-cyan-500 to-blue-500 bg-zinc-600">

          <div>
            <ul className="items-stretch space-x-3 md:flex align-middle px-1 flex justify-end mr-10 h-14">
			    <li className="flex">
				    <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-white">Sobre Nosotros</a>
			    </li>
        ...
        <section className="py-6 bg-white text-gray-900">
	        ...
	        <div className=" p-6 lg:container mx-auto space-y-8">

		        <div className="space-y-2 text-center">
			        <h2 className="text-3xl font-bold">NOTICIAS</h2>
		        </div>

		        <div className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3">

			        <article className="flex flex-col bg-white rounded-lg border-2 border-blue-500">
				        ...
				        <div className="flex flex-col flex-1 p-3">
					        ...
					        <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-gray-900">Lorem Ipsum</a>
					        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">It is a long established fact that a reader will be distracted by the readable content
                  of a page when looking at its layout.</h3>    
				        </div>

                <div className="flex w-full">
                  <button className="mx-auto bg-blue-500 rounded px-4 py-2 mb-5">Entrar</button>
                </div>
			        </article>
	...
	<div className="container mx-auto space-y-12">
		...
		<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
			...
			<div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-900">
				...
				<p className="my-6 dark:text-gray-400">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard</p>

        <div className="flex w-full">
				  <button type="button" className="self-start mx-auto bg-blue-500 rounded px-4 py-2 mb-5">Entrar</button>
        </div>
			</div>
		</div>
	</div>
...
<footer className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
	<div className="container flex flex-col p-4 mx-auto lg:flex-row divide-gray-400">
